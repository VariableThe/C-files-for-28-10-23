...
namespace Aditya
{
    class program
    {
        static void Main(String[] args)
        {
            ...
            /* I know I could've returned false or true by setting up a boolean and changing it's values in the if curly brackets and then printing that out
             * I just felt it would better to have an actual response rather than a true or false.
